...
POS por código o por nombre. Por dentro es una receta de una línea, así que el
food cost y el descuento de cámara salen del mismo motor de siempre, sin una
segunda manera de calcular lo mismo.
...
thegrill/meat/
  app.py           Las rutas: acceso, hoy, recepción, despiece, cámara,
                   descongelado, cortes, carta, ventas, inventario, merma,
                   trazabilidad, avisos, equipo, configuración y descargas
  service.py       Lo que esta edición hace y la cocina no tenía pantalla:
                   alta de primales, despiece desde formulario, catálogo de
                   cortes, carta de carnes y el resumen de hoy
  sheets_meat.py   Las cinco hojas imprimibles
  i18n_meat.py     102 textos propios × seis idiomas
